...
| 8.3 | The rest of chat: the model on the web under a spend cap, human chat, off-turn talk with pacing, debriefs after web games | built 2026-09-19 on fake backends (8.3a-c, `docs/phase8-plan.md` 12); the deploy with the key and the three live checks follow -- `docs/web.md` |
